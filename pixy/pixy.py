...
def pixy_command(*args):
  return _pixy.pixy_command(*args)
pixy_command = _pixy.pixy_command

def pixy_led_set_RGB(*args):
  return _pixy.pixy_led_set_RGB(*args)
pixy_led_set_RGB = _pixy.pixy_led_set_RGB

def pixy_led_set_max_current(*args):
  return _pixy.pixy_led_set_max_current(*args)
...
def pixy_cam_set_auto_white_balance(*args):
  return _pixy.pixy_cam_set_auto_white_balance(*args)
...
def pixy_cam_set_white_balance_value(*args):
  return _pixy.pixy_cam_set_white_balance_value(*args)
pixy_cam_set_white_balance_value = _pixy.pixy_cam_set_white_balance_value

def pixy_cam_set_auto_exposure_compensation(*args):
  return _pixy.pixy_cam_set_auto_exposure_compensation(*args)
...
def pixy_cam_set_exposure_compensation(*args):
  return _pixy.pixy_cam_set_exposure_compensation(*args)
pixy_cam_set_exposure_compensation = _pixy.pixy_cam_set_exposure_compensation

def pixy_cam_get_exposure_compensation(*args):
  return _pixy.pixy_cam_get_exposure_compensation(*args)
pixy_cam_get_exposure_compensation = _pixy.pixy_cam_get_exposure_compensation

def pixy_cam_set_brightness(*args):
  return _pixy.pixy_cam_set_brightness(*args)
...
def pixy_rcs_get_position(*args):
  return _pixy.pixy_rcs_get_position(*args)
pixy_rcs_get_position = _pixy.pixy_rcs_get_position

def pixy_rcs_set_frequency(*args):
  return _pixy.pixy_rcs_set_frequency(*args)
pixy_rcs_set_frequency = _pixy.pixy_rcs_set_frequency

def pixy_get_firmware_version(*args):
  return _pixy.pixy_get_firmware_version(*args)
